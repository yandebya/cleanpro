...
$(document).ready(function(){
	/*$('.nBtn, .table .eBtn').on('click',function(event){
		...
		if(text=='editer'){
			...
			$('.myForm #designationCategorie').val(categorie.designationCategorie);
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_utilisateur').val('');
			$('.myForm #nom_utilisateur').val('');
			$('.myForm #exampleModal').modal();
		}
	});*/
	$('.tab .delBtn').on('click',function(event){
		event.preventDefault();
		var href=$(this).attr('href');
		$('#myModal #delRef').attr('href',href);
		$('#myModal').modal();
	});
	$('.tab .blocBtn').on('click',function(event){
		event.preventDefault();
		var href=$(this).attr('href');
		$('#myModalBloc #blocRef').attr('href',href);
		$('#myModalBloc').modal();
		
		$("#blocRef").on("click", function(){
			
			swal("Succès!", "You clicked the button!", "success");
		})
		
	});
	//del exemlple
	$('table .image').on('click',function(event){
		event.preventDefault();
...
/*article*/
$(document).ready(function(){
	$('.nBtn2').on('click', function(){
		var text = $(this).text();
		if(text=='valider'){
		//$('select').each(function(){
		//	var select = $(this);
			//articles[select.attr('ca.idCategorie')]=select;
			$('.myForm2 #designationArticle').val('fgfgfg');
			$('.myForm2 #quantiteArticle').val('');
			$('.myForm2 #designationCategorie').val('');
...
$(document).ready(function() {
	$('.fonc').hide();
	$('.pers').hide();
	$('input:radio[name=utilisateur]:nth(0)').attr('checked',true);
	
	$('#per').on('click', function(){
		$('input:radio[name=utilisateur]:nth(1)').attr('checked',false);
		$('.fonc').show();
		$('.pers').hide();
	});
	$('#fou').on('click', function(){
		$('input:radio[name=utilisateur]:nth(0)').attr('checked',false);
		$('.fonc').hide();
		$('.pers').show();
...
/*$(document).ready(function() {
	$('.x_panel,.ccc').css('box-shadow','1px 1px 5px #7f8c9a');
	$('.x_panel ,.ccc').mouseenter(function(){
		event.preventDefault();
		$(this).css('box-shadow','2px 3px 5px #7f8c9a');
	
  });
	$('.x_panel,.ccc').mouseleave(function(){
		event.preventDefault();
		$(this).css('box-shadow','1px 1px 5px #7f8c9a');
...
$(document).ready(function() {
	...
	$('.img').mouseenter(function(){
		event.preventDefault();
		$(this).animate(1000).fadeTo(2,1);
		//$('#myModal').modal();
		//$(this).modal();
  });
	$('.img').mouseleave(function(){
		$(this).animate(1000).fadeTo(2,0.7);
  });
});
//jquery 2
$(document).ready(function() {
	$('#file_img,.for').on('click', function(){
		$(this).hide();
	});
});
/*$(document).ready(function() {
...
$('.nBtn, .table .eBtn').on('click',function(event){
	...
	if(text=='editer'){
		...
		$('.myForm #id_service').val(service.id_service);
		$('.myForm #libelle_service').val(service.libelle_service);
		$('.myForm #description_service').val(service.service_description);
	});
	$('.myForm #Modal').modal();
	}else{
		$('.myForm #id_service').val('');
		$('.myForm #libelle_service').val('');
		$('.myForm #description_service').val();
		$.get(href,function(categorieService, status){$('.myForm #categorie_service').val(CatServ.id_categorieServivce)});
		$('.myForm #Modal').modal();
	}
});*/
/*$(document).ready(function() {
$('.nBtn, .tab .eBtn').on('click',function(event){
	event.preventDefault();
	var href=$(this).attr('href');
	var text = $(this).text();
	if(text=='editer'){
		$.get(href,function(categorieService, status){
		$('.myForm #id_categorieServivce').val(categorieService.id_categorieServivce);
		$('.myForm #libelle_categorie').val(categorieService.libelle_categorie);
		$('.myForm #description_categorie').val(categorieService.description_categorie);
	});
	$('.myForm #exampleModal').modal();
	}else{
		$.get(href,function(categorieService, status){
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		if(text=='editer'){
			 ...
			 $('.myForm #libelle_categorie').val(categorieService.libelle_categorie);
			 $('.myForm #description_categorie').val(categorieService.description_categorie);
			 $('.myForm #picture').val(categorieService.photo_categorie);
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_categorieServivce').val('');
			$('.myForm #libelle_categorie').val('');
			$('.myForm #description_categorie').val('');
			$('.myForm #picture').val('');
			$('.myForm #exampleModal').modal();
		}
	});
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		var text = $(this).text();
		if(text=='editer'){
			 $.get(href,function(typeP, status){
			 $('.myForm #id_typeP').val(typeP.id_typeP);
			 $('.myForm #libelleP').val(typeP.libelleP);
			 $('.myForm #prixA').val(typeP.prixA);
			 $('.myForm #critereP').val(typeP.critereP);
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		var text = $(this).text();
		if(text=='editer'){
			 $.get(href,function(nationalite, status){
			 $('.myForm #id_nationalite').val(nationalite.id_nationalite);
			 $('.myForm #libelle_nationalite').val(nationalite.libelle_nationalite);
			 
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_nationalite').val('');
			$('.myForm #libelle_nationalite').val('');
			$('.myForm #exampleModal').modal();
		}
	});
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		var text = $(this).text();
		if(text=='editer'){
			 $.get(href,function(ville, status){
			 $('.myForm #id_ville').val(ville.id_ville);
			 $('.myForm #libelle_ville').val(ville.libelle_ville);
			 
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_ville').val('');
			$('.myForm #libelle_ville').val('');
			$('.myForm #exampleModal').modal();
		}
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		var href=$(this).attr('href');
		var text = $(this).text();
		//var id_ville=$("#yan").val();
		if(text=='editer'){
			 $.get(href,function(quartier, status){
			 $('.myForm #id_quartier').val(quartier.id_quartier);
			 $('.myForm #libelle_quartier').val(quartier.libelle_quartier);		 
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_quartier').val('');
			$('.myForm #libelle_quartier').val('');
			$.ajax({
				url:'listeVilleQaurt',
				method:"GET",
		...
		/*$('.persc').hide();
		if($('.myForm #libelle_quartier').on('click',function(event){
			
			$(this).css('box-shadow','11px 1px 2px green');
			$('.persc').show();
		}));*/
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		if(text=='editer'){
			 ...
			 $('.myForm #id_service').val(service.id_service);
			 $('.myForm #libelle_service').val(service.libelle_service);		
			 $('.myForm #description_service').val(service.description_service);		
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_service').val('');
			...
			$.ajax({
				...
				method:"GET",
				success: function(data){ 
					$('#id_categorieServivce').html(data);
				}
			});
			$('.myForm #exampleModal').modal();
		}
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		if(text=='editer'){
			 $.get(href,function(categorie, status){
			 $('.myForm #id_categorieServivce').val(categorie.id_categorieServivce);
			 $('.myForm #libelle_categorie').val(categorie.libelle_categorie);		
			 $('.myForm #description_categorie').val(categorie.description_categorie);		
			 $('.myForm #picture').val(categorie.photo_categorie);	
		});
		$('.myForm #exampleModal').modal();
		}else{
			$('.myForm #id_categorieServivce').val('');
...
$(document).ready(function(){
	$('.nBtn').on('click',function(event){
		event.preventDefault();
		var href=$(this).attr('href');
		var sexe_utilisateur = $("#sexe_utilisateur:checked").val();
		var text = $(this).text();
	
			$('.myForm #id_utilisateur').val('');
			$('.myForm #email_utilisateur').val('');
			$('.myForm #telephone_utilisateur').val('');
			$('.myForm #code_postal_utilisateur').val('');
			$('.myForm #age_utilisateur').val('');
			$('.myForm #sexe_utilisateur').val('');
			$('.myForm #picture').val('');
			$('.myForm #experience_proffessionel_pres').val('');
			$('.myForm #motivation_pres').val('');
			$.ajax({
				url:'listeVilleQaurt',
				method:"POST",
				success: function(data){ 
			...
			$("#yan").on("change", function(){
				var id_ville=$("#yan").val();
				//$("#error").html("");
				$.ajax({
					url:'ListeQuartierVille',
					method:"POST",
			...
			$.ajax({
				url:'listeNationaliteCP',
				method:"POST",
				success: function(data){ 
					$('#id_nationalite').html(data);
				}
			});
			$('.myForm #exampleModal').modal();
...
$(document).ready(function(){
	$('.nBtn').on('click',function(event){
		...
		var text = $(this).text();
			...
			/*$('.myForm #id_utilisateur').val('');*/
			$('.myForm #date_debut').val('');
			$('.myForm #date_fin').val('');
			$('.myForm #type').val('Reservation unique');
			...
			$("#yank").on("change", function(){
				var id_ville=$("#yank").val();
				//$("#error").html("");
				$.ajax({
					url:'ListeQuartierVille',
					method:"POST",
...
/*reserver liste reservation*/
$(document).ready(function(){
	$('.nBtnR').on('click', function(){
		$.ajax({
			url:'reservationPres',
			method:"POST",
			data:{id_categorie:id_categorie},
			success: function(data){ 
				$("#id_prestataire").html(data);
			}
		});
	});
});
...
$(document).ready(function(){
	$('.nBtn, .table .eBtn').on('click',function(event){
		...
		var sexe_utilisateur = $("#sexe_utilisateur:checked").val();
		if(text=='editer'){
			 $.get(href,function(recruteur, status){
		     $('.myForm #id_utilisateur').val(recruteur.id_utilisateur);
			 $('.myForm #nom_utilisateur').val(recruteur.nom_utilisateur);
			 $('.myForm #prenom_utilisateur').val(recruteur.prenom_utilisateur);
			 $('.myForm #age_utilisateur').val(recruteur.age_utilisateur);
				$('.myForm #sexe_utilisateur').val(recruteur.sexe_utilisateur);
...
//sous service
/*$(document).ready(function() {
	$("#id_service,#id_serv").on("change", function(){
		var id_service=$("#id_serv").val();
		//$("#error").html("");
		$.ajax({
			url:'resSousSere',
			method:"POST",
...
//      $("#remove").val(1);
    ...
    $(document).ready(function() {
    	$("#ville_erreur_message").hide();
    	
    	var ville_erreur=false;
    	
    	$("#libelle_ville").focusout(function(){	
    		check_ville();
    	});
    	function check_ville(){
    		var ville_lenght = $("#libelle_ville").val().length;
    		if(ville_lenght < 5){
    			$("#ville_erreur_message").html("caractere entrer trop court");
    			$("#ville_erreur_message").show();
    			ville_erreur=true;
    		}else{
    			$("#ville_erreur_message").hide();
    		}
    	...
    	$("#formulaire").submit(function(){
    		...
    		check_ville();
    		if(ville_erreur==false){
    			Swal.fire({
    				
    				  icon: 'success',
    				  title: 'enregistrement effectuer avec succès',
    				  showConfirmButton: false,
    				  timer: 5500
    				})
    			return true;
    		}else{
    			Swal.fire('Erreur...', 'verifier les champs!', 'error')
    			return false;
    		}
